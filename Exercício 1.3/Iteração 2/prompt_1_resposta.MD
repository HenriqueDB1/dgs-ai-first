...
> Transcrição na íntegra, em ordem cronológica. Cada turno está identificado pelo remetente (Usuário / Claude). Conteúdo preservado sem resumos, paráfrases, omissões ou alterações.
...
**Chunk 1 — POL-001-POLITICA-DEVOLUCAO** (seção: 3. Regras de Devolução > 3.1. Prazo geral)
...
---
**Chunk 2 — POL-001-POLITICA-DEVOLUCAO** (seção: 3. Regras de Devolução > 3.5. Custos de devolução)
> Contexto do documento: # POL-001 — Política de Devolução de Mercadorias
**Versão:** 3.1
**Última atualização:** 15/01/2024
**Responsável:** Diretoria de Operações
...
---
**Chunk 3 — POL-001-POLITICA-DEVOLUCAO** (seção: 3. Regras de Devolução > 3.3. Procedimento de devolução)
> Contexto do documento: # POL-001 — Política de Devolução de Mercadorias
**Versão:** 3.1
**Última atualização:** 15/01/2024
**Responsável:** Diretoria de Operações
...
---
**Chunk 4 — PROC-042-V2-FRETE-ESPECIAL-REVISADO** (seção: 3. Prazo de entrega para frete especial)
...
---
**Chunk 5 — PROC-042-FRETE-ESPECIAL-V1** (seção: 3. Prazo de entrega para frete especial)
...
**Resposta:** O cliente pode solicitar a devolução de mercadorias em até **7 (sete) dias úteis** após a data de recebimento confirmada no sistema de tracking. A contagem de dias úteis exclui sábados, domingos e feriados nacionais.
